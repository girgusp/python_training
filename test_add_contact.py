...
def test_add_contact(app):
    ...
    app.create_contact(Group(first_name="test_first_name", middle_name="test_middle_name",
...
def test_add_empty_contact(app):
    app.login(username="admin", password="secret")
    app.create_contact(Group(first_name="", middle_name="", last_name="", nickname="", title="", company="",
